...
1. Clone the repository
  ...
  ```
2. Create a TwelveLabs account
   
3. Sign up for a free account at Twelve Labs
   
4. Create and copy your API key from the dashboard
   
5. Copy and paste your API in the `.env` file e.g.
